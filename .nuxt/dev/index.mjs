...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, fetchWithEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, createError, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getRouterParam, getQuery as getQuery$1, readBody, getResponseStatusText } from 'file://E:/stepperTask/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file://E:/stepperTask/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file://E:/stepperTask/node_modules/devalue/index.js';
import destr from 'file://E:/stepperTask/node_modules/destr/dist/index.mjs';
import { hash } from 'file://E:/stepperTask/node_modules/ohash/dist/index.mjs';
import { renderSSRHead } from 'file://E:/stepperTask/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file://E:/stepperTask/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file://E:/stepperTask/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file://E:/stepperTask/node_modules/hookable/dist/index.mjs';
import { klona } from 'file://E:/stepperTask/node_modules/klona/dist/index.mjs';
import { snakeCase } from 'file://E:/stepperTask/node_modules/scule/dist/index.mjs';
import defu, { defuFn } from 'file://E:/stepperTask/node_modules/defu/dist/defu.mjs';
import { createStorage, prefixStorage } from 'file://E:/stepperTask/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://E:/stepperTask/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file://E:/stepperTask/node_modules/radix3/dist/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file://E:/stepperTask/node_modules/consola/dist/index.mjs';
import devalue from 'file://E:/stepperTask/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { getContext } from 'file://E:/stepperTask/node_modules/unctx/dist/index.mjs';
import * as vue$1 from 'file://E:/stepperTask/node_modules/vue/index.mjs';
import { version, unref } from 'file://E:/stepperTask/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file://E:/stepperTask/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file://E:/stepperTask/node_modules/@unhead/shared/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"E:/stepperTask/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"E:\\stepperTask","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"E:\\stepperTask\\server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"E:\\stepperTask\\.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"E:\\stepperTask\\.nuxt\\cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"E:\\stepperTask\\.data\\kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _B9lnvFLgBR = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "E:/stepperTask";

const asyncContext = getContext("nuxt-dev", { asyncContext: true, AsyncLocalStorage });
const _jMhCmGVjFw = (nitroApp) => {
...
var basestyle_cjs = BaseStyle;

const BaseStyle$1 = /*@__PURE__*/getDefaultExportFromCjs(basestyle_cjs);
...
const styles$2 = [
  ,
  BaseStyle$1 && BaseStyle$1.getStyleSheet ? BaseStyle$1.getStyleSheet(undefined, styleProps) : ''
].join('');

const defineNitroPlugin = (def) => def;
const _44MRMWV9Ts = defineNitroPlugin(async (nitroApp) => {
...
const _lazy_XR5mMR = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_XR5mMR, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_XR5mMR, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('file://E:/stepperTask/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
